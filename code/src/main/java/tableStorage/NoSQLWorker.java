...
public class NoSQLWorker {
	...
	private static NoSQL service=new NoSQL();
	...
	public static void process(String str) 
	{
		...
		{
			service.findCustomerByid(json.getString("id"));
		}
		
		else if(type.equals("findOrderById"))
		{
			service.findOrderById(json.getString("id"));
		}
		
		else if(type.equals("average"))
		{
			System.out.println(service.average(json.getString("country")));
		}
			
		else if(type.equals("total"))
		{
			System.out.println(service.total(json.getString("country")));			
		}
		
		else if(type.equals("listRecentOrders"))
		{
			service.ListRecentOrders(json.getString("country"));
		}
	...
	private static boolean checkMessage(String str)
	{
		...
		{
			JSONObject json=new JSONObject(str);
			return !service.checkMessage(json.getString("messageId"));
		}
		catch(Exception e)
		{
			return false;
	...
	private static void storeMessage(String str)
	{
		...
		{
			JSONObject json=new JSONObject(str);
			service.receivedMessage(json.getString("messageId"), json.toString());
...
//		    	System.out.println(message);
		    	...
		    	{
		    		System.out.println("message for MSSQL");
		    	}
		    	
		    	
		    	else if(sqlType.equals("NoSQL"))
		    	{
		    		CloudQueueMessage retrievedMessage = queue.retrieveMessage();
